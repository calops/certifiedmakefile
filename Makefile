...
TARGET_NAM	= $(RADICAL_TARGET)$(HTML_FILES)
...
# declaration should 've its own verbose and excplicit comment describing its
# behavior.
...
SUCCESS_STR = "Success"
FAILURE_STR = "Failure"
SUCCESS       = $($TEST_NAME_SCHEME)$(SUCCESS_STR)
FAILURE       = $($TEST_NAME_SCHEME)$(FAILURE_STR)
...
test:
	...
	# FIXME: there are hardcoded strings in this command. This is unacceptable. >> Okay, fix it dude, but delete this fucking comment...
	@$(DIFF_COMMAND) $(TEST_DIR)$(SLASH)index.html $(TEST_DIR)$(SLASH)index.html.ref && echo $(VARIABLETESTSUCCESS) || echo $(VARIABLETESTFAILURE)
