...
VARIABLEPYTHONINTERPRETER = $(VARIABLEFORPATHSEPARATOR)usr$(VARIABLEFORPATHSEPARATOR)bin$(VARIABLEFORPATHSEPARATOR)env python2
VARIABLESED               = $(VARIABLEFORPATHSEPARATOR)bin$(VARIABLEFORPATHSEPARATOR)sed
VARIABLEMARKDOWNMODULE    = markdown
VARIABLERMBINARY          = $(VARIABLEFORPATHSEPARATOR)bin$(VARIABLEFORPATHSEPARATOR)rm
VARIABLETESTDIR           = t
VARIABLEDIFF              = $(VARIABLEFORPATHSEPARATOR)usr$(VARIABLEFORPATHSEPARATOR)bin$(VARIABLEFORPATHSEPARATOR)diff
VARIABLECD                = cd
...
test:
	...
	$(VARIABLEDIFF) $(VARIABLETESTDIR)$(VARIABLEFORPATHSEPARATOR)index.html $(VARIABLETESTDIR)$(VARIABLEFORPATHSEPARATOR)index.html.ref && echo $(VARIABLETESTSUCCESS) || echo $(VARIABLETESTFAILURE)
